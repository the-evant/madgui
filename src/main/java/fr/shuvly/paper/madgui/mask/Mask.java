package fr.shuvly.paper.madgui.mask;
...
public class Mask
{
	...
	private final MadGui gui;
	private final Map<Character, MadItem> items;
	 ...
	 * @return	Itself
	 */
	public Mask setItem(Character character, MadItem item)
	{
	...
	{
		return this.setItem(character, new MadItem(item));
	}
	 ...
	 * @return	Items
	 */
	public Map<Character, MadItem> getItems()
	{
		return this.items;
	}
	 ...
	 */
	public MadItem getItem(Character character)
	{
